...
//--- CW Decoder ---
#define CW_DECODER_DEFAULT_FREQUENCY \
  750  // Alapértelmezett CW dekóder frekvencia (Hz)
...
#define RTTY_SHIFT_FREQUENCY \
  RTTY_MARKER_FREQUENCY -    \
      RTTY_SPACE_FREQUENCY  // RTTY eltolás frekvencia (170Hz)
